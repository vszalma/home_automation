...
set PYTHON_EXE=E:\vszalma\Source\Repos\home-automation\home_automation\.venv\Scripts\python.exe

REM Change directory to project root so relative imports work
cd /d E:\vszalma\Source\Repos\home-automation\home_automation\
...
%PYTHON_EXE% copy_master.py --source E:\_temp\CathyK --destination N:\CathyK --retry 50
